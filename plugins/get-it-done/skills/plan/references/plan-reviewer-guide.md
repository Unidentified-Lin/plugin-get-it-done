...
- [ ] **異動範圍** is concrete: real module/service names, not "TBD"
- [ ] No obvious impacted module is missing from scope
- [ ] Scope matches what 需求重點 describes (no silent expansion)
- [ ] **異動範圍（詳細）** lists changes at function/method level (not just class/module level)
- [ ] Every function/method listed in 異動範圍（詳細） has a verified file path
...
- [ ] Implementation steps use concrete function/class names
- [ ] Verification method is specific and checkable
- [ ] Test flag is explicitly set (not blank)
- [ ] No step contains "TBD" or other vague wording

### Section 5: Impact Scope Coverage

- [ ] **影響範圍** section exists and is not empty/TBD
- [ ] **直接影響** lists callers/consumers of modified functions
- [ ] **間接影響** considers shared types, events, API contracts
