...
**Rule**: Decision matrix for fixes:
  ...
  - **Per-project fact** (`team/context/{domain_knowledge,tech_stack,codebase_map,decisions,stakeholder_notes}.md`) — a learning that applies only to *this* project. See the classification matrix in `agents/reflector.md`.
